...
- `memory/`：元记忆类文件
  - `量潮第二大脑章程` → 量潮第二大脑章程（源自 quanttide-bylaw-of-asset-management/schema/second-brain.md）
- `data/`：数据类子模块
  ...
  - `journal` → [quanttide-journal-of-philosophy](https://github.com/quanttide/quanttide-journal-of-philosophy)（量潮元工程日志）
...
- 教程类子模块：保持"哲学教程"命名（`quanttide-tutorial-of-philosophy`）
- 其他子模块：统一使用"元工程"命名体系（量潮元工程图书馆、量潮元工程路线图、量潮元工程日志、量潮元工程语境、量潮元工程实验室、量潮元工程章程）
